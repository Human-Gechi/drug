...
from src.greenbook import GREENBOOK_URL, expand_terms, map_to_active
...
SITE_MAP: List[Dict] = [
    ...
    {"topic": "registered_products", "keywords": ["registered", "registration number", "reg no", "reg. no", "nrn", "greenbook", "green book", "product database", "is this product", "is this drug", "approved", "licensed", "licenced", "nafdac number", "nafdac no"],
     "urls": [], "abs_urls": [GREENBOOK_URL], "greenbook": True},
    ...
    {"topic": "chemicals", "keywords": ["chemical", "chemicals", "pesticide", "pesticides", "detergent", "disinfectant", "disinfectants", "restricted", "prohibited", "banned substance", "controlled substance"],
     "urls": ["/chemicals/"]},
    ...
    {"topic": "drugs", "keywords": ["drug", "medicine", "pharma", "tablet", "syrup", "antimalarial", "napar"],
     "urls": ["/drug/", "/drugs/"], "abs_urls": [GREENBOOK_URL], "greenbook": True},
...
_TERM_STRIP = {
    ...
    "from", "this", "that", "these", "those", "and", "or",
    "it", "its", "me", "my", "your", "our", "you",
    "any", "there", "which", "what", "who", "how", "when", "where", "why",
    "whether", "if", "please", "tell", "show", "check", "find", "see",
    "registered", "registration", "register", "approved", "approval", "approve",
    "licensed", "licenced", "license", "verify", "verified", "verification",
    "authentic", "authorised", "authorized", "genuine", "valid", "legit",
    "legitimate", "fake", "counterfeit", "original", "real", "safe", "status",
    "nafdac", "nafdacs", "greenbook", "green", "book", "reg", "no", "number",
    "nrn", "recall", "recalled", "withdrawn", "banned",
    "product", "products", "drug", "drugs", "medicine", "medicines",
    "kind", "kinds", "type", "types", "sort", "sorts", "form", "forms",
    "brand", "brands", "variant", "variants", "version", "versions",
    "option", "options", "example", "examples", "sample", "samples",
    "different", "various", "available", "some", "many", "much",
    "all", "every", "each", "both", "several", "few",
    "list", "lists", "listing", "enumerate",
    "last", "latest", "newest", "new", "recent", "current", "first", "oldest",
    "previous", "next", "today", "now",
    "item", "items", "thing", "things", "one", "two", "three",
    "website", "site", "page", "pages", "record", "records",
    "entry", "entries", "name", "names", "called", "known",
    "still", "currently", "yet", "also",
    "alert", "alerts", "recalls", "notice", "notices",
    "warning", "warnings", "fsn", "fsns", "withdraw", "withdrawal",
    "withdrawals", "ban", "blacklist", "blacklisted",
    "watchlist", "watchlisted", "suspended", "suspend",
    "cancelled", "canceled", "cancel", "deregistered", "delisted",
    "counterfeit", "falsified", "substandard", "seizure", "poisoning",
    ...
    "chemical", "chemicals", "restricted", "restriction", "restrictions",
    "prohibited", "controlled", "substance", "substances",
    "device", "devices", "cosmetic", "cosmetics",
    "vaccine", "vaccines", "biological", "biologicals",
    "food", "foods", "water", "beverage", "beverages",
    "veterinary", "narcotic", "narcotics", "herbal", "herbs",
    "section", "sections", "category", "categories", "class", "classes",
    "pesticide", "pesticides", "detergent", "detergents",
    "disinfectant", "disinfectants",
    ...
    "guideline", "guidelines", "regulation", "regulations",
    "requirement", "requirements", "standard", "standards",
    "procedure", "procedures", "process", "processes",
    "rule", "rules", "law", "laws", "act", "acts",
    "policy", "policies", "circular", "circulars", "directive", "directives",
    "notice", "notices", "tariff", "tariffs", "fee", "fees"
}
...
_CATEGORY_ONLY = {
    "chemical", "chemicals", "restricted", "restriction", "restrictions",
    "banned", "prohibited", "controlled", "substance", "substances",
    "device", "devices", "cosmetic", "cosmetics",
    "vaccine", "vaccines", "biological", "biologicals",
